  ...
  "Home": {
    ...
    "Carousel6": {
      "custom": {
        ...
        "startTile": 0,
        "imageItems": [
          "/app-assets/services1.svg",
          "/app-assets/services3.svg",
          "/app-assets/services2.svg"
        ]
      },
      "callbacks": {
        "onClick": [
    ...
    "Image25": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/product-design.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image28": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/Web-Design-2.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image41": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/product-designer1.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image42": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/product-designer2.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image43": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/product-designer4.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image44": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/product-designer3.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image45": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/cross-arrow.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image60": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/white-chevron.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image61": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/white-chevron-right.svg"
      },
      "callbacks": {
        "onClick": [
          {
